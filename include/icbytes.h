...
public:
    ...
    //_________SAFE /SAÐLAM UNSIGNED CHAR (BYTE)ACESS______________
    ...
    //_________ SAFE /SAÐLAM UNSIGNED INT(32) ACESS ________________
...
int ResizeMatrix(ICBYTES& i, long long x, long long y, int z, int w);
